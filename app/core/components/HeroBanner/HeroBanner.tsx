...
const items = [
    <div key={1}>
        <Image height="1600" width="1800" alt="slides" src="/slide-1.png" className="aspect-[16/10] md:aspect-auto object-cover"/>
    ...
    <div key={2}>
        <Image height="1600" width="1800" alt="slides" src="/slide-2.png" className="aspect-[16/10] md:aspect-auto object-cover"/>
        <div className="px-[15px] md:px-[40px] py-[10px] md:py-[25px] bg-white absolute
                        bottom-[25px] md:bottom-[75px] left-0 text-black/[0.9]
                        text-[15px] md:text-[30px] uppercase font-medium cursor-pointer hover:opacity-90">
            Shop Now
    ...
    <div key={3}>
        <Image height="1600" width="1800" alt="slides" src="/slide-3.png" className="aspect-[16/10] md:aspect-auto object-cover"/>
        <div className="px-[15px] md:px-[40px] py-[10px] md:py-[25px] bg-white absolute
                        bottom-[25px] md:bottom-[75px] left-0 text-black/[0.9]
                        text-[15px] md:text-[30px] uppercase font-medium cursor-pointer hover:opacity-90">
            Shop Now
